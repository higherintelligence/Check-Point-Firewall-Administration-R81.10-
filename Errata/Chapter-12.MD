...
3. Page 450 step 5 fails
    ...
    - It's best that as part of page 468 step 1 to create a new rule 2 to allow CPSMS to CPGW_tmp for services CPD (tcp/19191), CPD_amon (tcp/18192),  and FW1_ica_push (tcp/18211)
